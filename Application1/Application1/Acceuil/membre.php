<?php
session_start(); 
$bdd = new PDO('mysql:host=localhost;dbname=kimz;', 'root', '');
...
if(isset($_POST['envoi'])){
  if(!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['specialité']) && !empty($_POST['profile']) && !empty($_POST['description'])){
    ...
    $insererArticle = $bdd->prepare('INSERT INTO candidats(nom,prenom,specialité,profile,description) VALUES (?, ?, ?, ?, ?)');
                      ...
                      <div class="form-group d-flex">
                        <li class="nav-item dropdown" style="margin-top:-10px;">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="index.php" style="text-decoration: none;">HOMME</a></li>
 ...
 <strong> ADMIN PROFILE</strong>
  ...
  <div class="offcanvas offcanvas-start text-bg-dark" id="demo">
    ...
    <div class="offcanvas-body" >
      <p><button class="btn " type="button" style="color:whitesmoke;font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;"><span><a href="try.php" style="text-decoration: none;">DASHBOARD DES RECRUTTEUR</a></span></button></p>
  ...
  <div class="container-fluid mt-3">
      ...
      <h3 style="color:antiquewhite;text-align:center">LES CONDIDATS INSCRITS A NOTRE SITE: </h3>  
  <br>
    <br><br>
    ...
    <tbody> 
      <?php
$recupUsers = $bdd->query('SELECT * FROM candidats');
...
<form method="POST" action="">
      <th><input type="text" name="id" style="width:30px;" ></th>
        ...
        <td><input type="text" name="prenom" style="width:70px;">
          ...
          <td><input type="text" name="specialité" style="width:70px;">
</input></td>
           <td><input type="text" name="profile" style="width:70px;"></input></td>
